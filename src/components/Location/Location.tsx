...
const Location = () => {
  ...
  const handleNaverMap = () => {
    window.open('https://map.naver.com/p/search/부산광역시%20남구%20전포대로%2026%20W웨딩%20더에스웨딩홀');
  };
  ...
  return (
    <Section ref={ref}>
      ...
      >
        ...
        <NavigationButtons>
          <NavButton onClick={handleNaverMap}>
            네이버 지도
          </NavButton>
          <NavButton onClick={handleKakaoMap}>
            카카오 지도
          </NavButton>
        </NavigationButtons>
